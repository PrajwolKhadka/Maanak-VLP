  ...
  return (
    <div className="min-h-screen relative flex items-center justify-end pr-50">
      ...
      <div className="relative z-20 w-full max-w-lg bg-white rounded-2xl shadow-2xl p-10 mx-4">
        <h2 className="text-2xl font-bold text-gray-900 mb-1">Login into your account</h2>
        <p className="text-gray-400 text-sm mb-6">
          Continue your journey of <span className="text-purple-400">excellence</span>
        </p>
        ...
        <div className="flex flex-col gap-4 text-black">
          ...
          <div>
            ...
            <p className="text-right text-xs text-purple-400 mt-1 cursor-pointer hover:underline">
              Forgot Password?
            </p>
          </div>
