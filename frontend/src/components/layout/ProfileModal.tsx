      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative">
        ...
        {!showDeleteConfirm ? (
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-6 flex flex-col gap-2">
              ...
              {user?.contact && (
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-700">{user.contact}</span>
                </div>
              )}
              {user?.gender && (
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-400">Gender</span>
                  <span className="text-sm font-medium text-gray-700 capitalize">{user.gender}</span>
                </div>
              )}
            </div>
          ...
          <div>
            ...
            <div className="mb-4">
              <label className="text-sm text-gray-600 mb-1 block">Reason for leaving</label>
            ...
            <div className="flex gap-3">
              <button onClick={() => { setShowDeleteConfirm(false); setError(''); }}
